 ...
 *
 */
public class PagingBean_backup {
	/**
	 * 총 데이터(내용들:rows)의 개수
	 */
	 ...
	 * @param currentPage
	 */
	public PagingBean_backup(int totalContent, int currentPage){
	...
	public static void main(String[] args) {
		PagingBean_backup d = new PagingBean_backup(201, 5);//총 201개 row, 현재page : 5
		//page내 보여질 내용의 개수 - 5
		//page그룹내 page수 - 10
