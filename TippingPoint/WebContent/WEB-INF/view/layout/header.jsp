				...
				<ul class="nav navbar-nav">
					...
					<!-- TODO 프로젝트 카테고리 자동출력-->
						...
						<li><a href="${initParam.rootPath}/tpProjectBoard.tp">모두보기</a></li>
							<c:forEach items="${requestScope.categoryList }" var="list">
								<li><a href="${initParam.rootPath }/tpProjectCategoryBoard.tp?&tppCategory=${list.tppCategory }">${list.tppCategoryName }</a></li>
							</c:forEach>
					...
					<li>
						<form action="${initParam.rootPath}/tpProjectSearching.tp" method="post">
							<input class="form-control search" placeholder=" 프로젝트명으로 검색하기" type="text" name = "keyWord">
