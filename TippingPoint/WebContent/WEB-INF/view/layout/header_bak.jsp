...
&nbsp;
<a href="${initParam.rootPath}/tpProjectRegister.tp"> 프로젝트 등록하기</a>&nbsp;
<a href="${initParam.rootPath}/tpProjectBoard.tp?pageNo=${param.pageNo }">프로젝트 둘러보기</a>&nbsp;
<a href="${initParam.rootPath}/tpNoticeBoard.tp?pageNo=${param.pageNo }">NOITCE</a>&nbsp;
<br />
