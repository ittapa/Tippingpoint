...
SELECT		TPFQUALIFYTPPROPOSER
			...
			select TPFID, TPFNAME, TPFPASSWORD, TPFBIRTH, TPFGENDER,  TPFEMAIL, TPFZIPCODE,  TPFADDRESS,
        		   TPFADDRESS_D, TPFPHONENUM, TPFQUALIFYTPPROPOSER,  TPFACCOUNTTYPE, TPFPROFILEIMG
		from (
			select TPFID, TPFNAME, TPFPASSWORD, TPFBIRTH, TPFGENDER,  TPFEMAIL, TPFZIPCODE,  TPFADDRESS,
        		   TPFADDRESS_D, TPFPHONENUM, TPFQUALIFYTPPROPOSER,  TPFACCOUNTTYPE, TPFPROFILEIMG, ceil(rownum/10) page
			from(
				select TPFID, TPFNAME, TPFPASSWORD, TPFBIRTH, TPFGENDER,  TPFEMAIL, TPFZIPCODE,  TPFADDRESS,
        		   TPFADDRESS_D, TPFPHONENUM, TPFQUALIFYTPPROPOSER,  TPFACCOUNTTYPE, TPFPROFILEIMG
				from TPFUNDER
